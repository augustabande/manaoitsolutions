      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-8 text-center text-lg-start wow fadeInUp">
            ...
            <p className="text-5">
              I'm a web developer and IT consultant with a passion for web design. I
              enjoy developing simple, clean and slick websites that provide
              real value to the end user. 
            </p>
            <p className="text-5">
              I spent the last 10 years working as IT consultant for International and Governmental Organizations in the scientific field.
            </p>
          </div>
          <div
        ...
        {/*<div className="row gy-3 mt-4">
          <div className="col-6 col-lg-3 wow fadeInUp">
            ...
            <p className="text-4 text-dark fw-600 mb-0">Augusta Bande</p>
          </div>
          <div className="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <p className="text-4 fw-600 mb-0">
              <a className="link-dark" href="mailto:augusta.bande@gmail.com">
          ...
          <div className="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <p className="text-4 text-dark fw-600 mb-0">25 January, 1982</p>
          </div>
          <div className="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
            <p className="text-muted fw-500 mb-0">From</p>
            <p className="text-4 text-dark fw-600 mb-0">Fuerteventura, Spain.</p>
          </div>
        </div>*/}
      </div>
    </section>
